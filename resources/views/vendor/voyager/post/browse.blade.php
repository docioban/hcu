...
@section('page_header')
    <a href="candidate/{{$idCandidate}}/edit">
        <h1 class="page-title">
            {{ __('voyager::generic.edit').'Candidate' }}
        </h1>
    </a>
    <a href="{{ route('voyager.post.index', ['idCandidate' => $idCandidate]) }}">
        <h1 class="page-title">
            {{ __('voyager::generic.edit').' Posts' }}
        </h1>
    </a>
                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-hover">
                                ...
                                @foreach($dataTypeContent as $data)
                                    @if ($data->candidate_id == $idCandidate or $idCandidate == null)
                                        <tr>
                                            @can('delete',app($dataType->model_name))
                                                <td>
